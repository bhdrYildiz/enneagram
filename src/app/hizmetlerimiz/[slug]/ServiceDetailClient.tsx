                ...
                <div className="mt-10 grid grid-cols-1 lg:grid-cols-[360px_1fr] gap-10 items-start">
                    ...
                    <div className="rounded-md border border-black/10 bg-white p-8 md:p-10 shadow-[0_14px_40px_rgba(0,0,0,0.06)]">
                        <div className="flex items-start justify-between gap-8">
                            ...
                            <div className="hidden md:block relative h-28 w-72 rounded-md border border-black/10 bg-white shadow-sm">
                                <Image
                                    src={service.logo}
                                    alt={service.title}
                                    fill
                        ...
                        {service.longDescription && (
                            <div className="mt-10 text-[17px] leading-relaxed text-primary/75 whitespace-pre-line">
                                {service.longDescription}
                            </div>
                        )}
                    </div>
