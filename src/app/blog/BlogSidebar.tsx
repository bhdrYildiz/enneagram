        ...
        <aside className="lg:sticky lg:top-28 self-start">
            <div className="bg-white border border-black/10">
                <div className="p-8 text-center border-b border-black/10">
                    ...
                    <p className="mt-5 text-xl font-light text-primary">Enneagram Eğitim & Danışmanlık</p>
                    ...
                    <div className="flex justify-center gap-4 mt-6 text-primary">
                        ...
                        <Link
                            ...
                            prefetch={false}
                        >
                            <FaWhatsapp className="hover:text-secondary transition" />
                        </Link>
                    </div>
                </div>
                <div className="p-6 border-b border-black/10">
                    <form action="/blog" method="get" className="flex">
                        <input
                            ...
                            className="w-full border border-black/10 px-4 py-3 text-sm text-primary outline-none focus:border-secondary"
                        />
                        <button
                            type="submit"
                            aria-label="Arama yapın"
                            className="shrink-0 w-12 bg-[#1c2c34] text-white hover:bg-secondary cursor-pointer transition"
                        >
