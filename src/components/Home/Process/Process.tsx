        ...
        <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-20">
                    <span className="uppercase tracking-[0.35em] text-secondary text-sm">Enneagram</span>
                    ...
                    <p className="max-w-3xl mx-auto mt-6 text-gray-600 text-lg leading-8">
                        Mizaç merkezli yaklaşım; okuldan aileye, kurumlardan bireysel gelişime kadar birçok alanda kalıcı dönüşüm sağlar.
                    </p>
                </div>

                <div className="grid md:grid-cols-2 gap-8">
                    {steps.map((step) => (
                        <motion.div key={step.no} whileHover={{ y: -8 }} transition={{ duration: 0.25 }}>
                            <Link href="/hizmetlerimiz" className="group block rounded-3xl overflow-hidden bg-white border border-slate-200 shadow-lg hover:shadow-2xl transition-all duration-300">
                                <div className="relative h-72 overflow-hidden">
                                    <Image src={step.image} alt={step.title} fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" />
                                ...
                                <div className="p-8">
                                    ...
                                    <div className="mt-8 inline-flex items-center gap-3 text-secondary group-hover:gap-5 transition-all">
                                        Daha Fazla
                                        <FiArrowUpRight />
                                    </div>
                                </div>
